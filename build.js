...
async function buildAll() {
  try {
    ...
    await build({
      ...
      platform: 'browser',
      banner: {
        js: `/*! @sashbot/uibridge v1.3.2 | MIT License | https://github.com/sashbot/uibridge-js */`
      }
    });
    ...
    await build({
      ...
      platform: 'neutral',
      banner: {
        js: `/*! @sashbot/uibridge v1.3.2 ESM | MIT License */`
      }
    });
    ...
    await build({
      ...
      platform: 'node',
      banner: {
        js: `/*! @sashbot/uibridge v1.3.2 CJS | MIT License */`
      },
      footer: {
        js: `
...
function generateTypeDefinitions() {
  const dts = `// Type definitions for @sashbot/uibridge v1.3.2
